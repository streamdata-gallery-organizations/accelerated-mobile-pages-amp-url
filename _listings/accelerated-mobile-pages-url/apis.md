...
- name: 'Accelerated Mobile Pages (AMP) URL API '
  ...
  baseURL: ://acceleratedmobilepageurl.googleapis.com////v1/ampUrls:batchGet
  tags: AMP URLs
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/accelerated-mobile-pages-url/master/_listings/accelerated-mobile-pages-url/v1ampurlsbatchget-post-openapi.md
- name: Accelerated Mobile Pages (AMP) URL API
  x-api-slug: accelerated-mobile-pages-amp-url-api
  description: 'AMP is a way to build web pages for static content that render fast.
    AMP in action consists of three different parts: AMP HTML is HTML with some restrictions
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/accelerated-mobile-pages-url/master/_listings/accelerated-mobile-pages-url/openapi.md
x-common:
- type: x-blog
